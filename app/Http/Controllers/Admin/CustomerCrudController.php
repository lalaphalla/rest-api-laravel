...
class CustomerCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        // $this->crud->setValidation(\App\Http\Requests\CustomerRequest::class);

        $this->crud->addField(['name' => 'name', 'type' => 'text']);
        $this->crud->addField(['name' => 'email', 'type' => 'email']);
        $this->crud->addField(['name' => 'type', 'type' => 'text']);
        $this->crud->addField(['name' => 'address', 'type' => 'text']);
        $this->crud->addField(['name' => 'city', 'type' => 'text']);
        $this->crud->addField(['name' => 'state', 'type' => 'text']);
        $this->crud->addField(['name' => 'postal_code', 'type' => 'text', 'label' => 'Postal Code']);
